...
The models have been trained on the [German Traffic Sign dataset](http://benchmark.ini.rub.de/?section=gtsrb&subsection=dataset) so some of the traffic signs might be different from the ones you encounter. The models can recognize the following categories:
- speed limit 20
- speed limit 30
- speed limit 50
- speed limit 60
